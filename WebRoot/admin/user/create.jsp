...
<div class="container">
  		...
  		<s:form action="CreateUser" theme="simple">
	  		<table class="hoverable">

				<tr>
				<td><font><b>Name:</b></font></td>
				<td>
					<s:textfield name="userPrm.name" id="txtfld_name" size="15" maxlength="50" required="true"></s:textfield>			
				</td>
				<td>
				  <button class="btn waves-effect waves-light" type="submit" name="btn_create" onclick="check()">Create
				...
				<td>
					<s:textfield name="userPrm.password" id="txtfld_password" size="15" maxlength="50" required="true"></s:textfield>			
				</td>
				<td></td>				
				</tr>									
				...
				<td>
					<s:textfield name="userPrm.type" id="txtfld_type" size="15" maxlength="50" required="true"></s:textfield>			
				</td>
				<td></td>				
				</tr>	
				...
				<td>
					<s:textfield name="userPrm.role" id="txtfld_role" size="15" maxlength="50" required="true"></s:textfield>			
				</td>
				<td></td>				
				</tr>	
